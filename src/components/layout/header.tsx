...
import { ShoppingCart, Heart, Menu, X, User, LogOut, LayoutDashboard, Shield, UserCircle } from "lucide-react"
                ...
                <div className="flex flex-col space-y-2 pt-4 border-t border-white/20">
                  {user ? (
                    <>
                      <Link
                        href="/profile"
                        className="flex items-center text-foreground hover:text-royal-blue transition-colors font-medium"
                      >
                        <UserCircle className="mr-2 h-4 w-4" />
                        Profile
                      </Link>
